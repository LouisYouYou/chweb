  ...
  return (
    <div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {serviceTimes.map((s) => (
              <div key={s.id} className="bg-white border border-blue-100 rounded-2xl p-6 hover:shadow-lg transition-shadow hover:border-blue-300">
                ...
                <p className="text-2xl font-bold text-blue-700 my-2">{s.time}</p>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-blue-900 mb-10 text-center">{t('location_title')}</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            {/* Map placeholder */}
            <div className="rounded-2xl overflow-hidden shadow-md h-72 bg-blue-100 flex items-center justify-center">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-bold text-blue-900">{t('location_title')}</h3>
                </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-bold text-blue-900">{t('transport_title')}</h3>
                </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-bold text-blue-900">{t('parking_title')}</h3>
                </div>
